...
public class MeApkDownloadManager
{
			...
			MeApkDownloadCallBack CallBack )
	{
		...
		MeApkDownloadTask CurTask = new MeApkDownloadTask( ShowType , PkgName , CallBack , appName , size , versionName , entryID );
		...
		//MeGeneralMethod.startMeDLProtectionService( context.getApplicationContext() );
	...
	class MeApkDownloadTask
	{
				...
				int entryID )
		{
			...
			CurSDKDLTask = apkDlMgr.ResDownloadNewTask( CoolDLResType.RES_TYPE_APK , PackageName , CurCallback , MicroEntry.h12 , MicroEntry.h13 + entryID );
