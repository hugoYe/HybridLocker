...
public class LoadURL
{
	...
	public static String BaseDetalFolder64Str(
			Context context ,
			String pkgName )
	{
		String deskey = "8ufD05pL";
		String str = loadUrl( context ) + "h13:" + 0 + "|h14:" + MceInfo.instance( context ).getH14() + "|h15:" + pkgName + "|h16:folder" + "|h17:" + Utility.googlePalyIsInstall( context ) + "|h18:20150623";
		byte[] bs = null;
		try
		{
			...
			int id )
	{
		...
		String str = loadUrl( context ) + "h13:" + id + "|h14:" + MceInfo.instance( context ).getH14() + "|h17:" + Utility.googlePalyIsInstall( context ) + "|h18:20150623";
