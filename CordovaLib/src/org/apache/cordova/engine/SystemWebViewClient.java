...
/**
 * This class is the WebViewClient that implements callbacks for our web view. The kind of callbacks
 * that happen here are regarding the rendering of the document instead of the chrome surrounding
 * it, such as onPageStarted(), shouldOverrideUrlLoading(), etc. Related to but different than
 * CordovaChromeClient.
 */
public class SystemWebViewClient extends WebViewClient {
     ...
     */
    private Hashtable<String, AuthenticationToken>
        authenticationTokens =
        new Hashtable<String, AuthenticationToken>();
    ...
    /**
     * On received http auth request. The method reacts on all registered authentication tokens.
     * There is one and only one authentication token for any host + realm combination
     */
    @Override
    public void onReceivedHttpAuthRequest(WebView view, HttpAuthHandler handler, String host,
        ...
        if (pluginManager != null && pluginManager
            .onReceivedHttpAuthRequest(null, new CordovaHttpAuthHandler(handler), host, realm)) {
    ...
    /**
     * On received client cert request. The method forwards the request to any running plugins
    ...
    public void onReceivedClientCertRequest(WebView view, ClientCertRequest request) {
        ...
        PluginManager pluginManager = this.parentEngine.pluginManager;
        if (pluginManager != null && pluginManager
            .onReceivedClientCertRequest(null, new CordovaClientCertRequest(request))) {
            parentEngine.client.clearLoadTimeoutTimer();
            return;
        }
     ...
     * resource is unavailable). The errorCode parameter corresponds to one of the ERROR_*
     * constants.
     *
     * @param view        The WebView that is initiating the callback.
    ...
    public void onReceivedError(WebView view, int errorCode, String description,
        ...
        LOG.d(TAG, "CordovaWebViewClient.onReceivedError: Error code=%s Description=%s URL=%s",
        ...
        try {
            ...
            if (!origUri.equals(remappedUri) || needsSpecialsInAssetUrlFix(origUri)
                ...
                CordovaResourceApi.OpenForReadResult
                    result =
                    resourceApi.openForRead(remappedUri, true);
